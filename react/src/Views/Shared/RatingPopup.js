...
const RatingPopup = ({ isVisible, onClose, isDarkMode }) => {
  ...
  const { structures, toggleStructureLiked, countLikedStructures } =
    useStructures();
  ...
  const renderRatingContent = () => {
    ...
    if (!currentStructure) {
      console.error(
        "Current structure is undefined:",
        currentIndex,
        structures.length
      );
      return null;
  ...
  const renderCompletionScreen = () => {
    ...
    return (
      <View style={styles.completeContainer}>
        ...
        <TouchableOpacity
          style={styles.exitButtonComplete}
          onPress={handleExit}
        >
  ...
  const renderRatingScreen = (currentStructure) => {
    return (
      <View style={styles.contentContainer}>
        <Text
          style={[styles.rateStructuresTitle, isDarkMode && styles.darkText]}
        >
          Rate Structures
        </Text>
        <View
          style={[
            ...
            styles.imageShadow,
            isDarkMode && styles.darkImageShadow,
          ]}
        >
          <FastImage
      ...
      >
        ...
        {!isComplete && (
          <TouchableOpacity style={styles.exitButton} onPress={handleExit}>
            <Text
              style={[styles.exitButtonText, isDarkMode && styles.darkText]}
            >
              Exit
            </Text>
          </TouchableOpacity>
