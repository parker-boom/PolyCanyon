...
- Apple Distribution signing is configured for Parker Jones's existing team. Build 1 has been uploaded, processed, and saved in the 6.0 draft; build 2 replaces it after cleanup validation.
- Four approved feature screenshots and the listing copy are saved in [App Store Connect](https://appstoreconnect.apple.com/apps/6499063781/distribution/ios/version/inflight).
